      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-2">
          ...
          <div className="flex items-center gap-2 mt-2">
            <div className="px-2 py-0.5 rounded-md bg-secondary/50 border border-white/5 text-[11px] font-bold text-muted-foreground uppercase tracking-wider">
              Phase 1
            </div>
        ...
        {ft.xpSystem && (
          <motion.div variants={itemVariants} className="mt-3 glass-card p-3">
            <div className="flex items-center justify-between text-[12px] font-bold text-muted-foreground mb-2 px-1">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-2">
                      <p className="text-[12px] font-black text-primary uppercase tracking-[0.2em] animate-pulse">
                        MAX_COACH_V2.1
                      </p>
                      <span className="px-1.5 py-0.5 rounded-[4px] bg-primary/10 border border-primary/20 text-[10px] font-bold text-primary uppercase">Active</span>
                    </div>
                  ...
                  <div className="flex items-center gap-1.5 mt-3 text-[11px] text-primary font-black uppercase tracking-widest opacity-70">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                ...
                {ft.mindfulnessTracker && mindfulStreak > 0 && (
                  <span className="px-1.5 py-0.5 rounded bg-primary/10 text-[11px] text-primary font-black uppercase">{mindfulStreak} Day Streak</span>
                )}
              </div>
              <p className="text-[11px] text-muted-foreground uppercase tracking-widest mt-1">Calm & Focus Training</p>
            </div>
        ...
        {recentWorkouts.length > 0 && (
          <motion.div variants={itemVariants} className="mt-4">
            <div className="flex items-center justify-between mb-2 px-1">
              ...
              <button className="text-[11px] font-bold text-primary uppercase tracking-widest">View All</button>
            </div>
                ...
                return (
                  <div key={w.date} className="glass-card-premium p-2.5 flex items-center gap-3 card-press border-white/5 bg-white/5">
                    ...
                    <div className="text-right">
                      ...
                      {isPerfect && <p className="text-[10px] font-black text-primary uppercase tracking-widest mt-0.5">Verified</p>}
                    </div>
                  </div>
                );
              })}
